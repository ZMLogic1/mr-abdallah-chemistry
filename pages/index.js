  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="كيمياء, ثانوية عامة, مستر عبد الله أشرف, Organic Chemistry, مراجعة كيمياء" />
      ...
      <div className="min-h-screen bg-slate-900 text-white font-sans selection:bg-cyan-500 selection:text-white" dir="rtl">
        ...
        <header className="py-20 text-center container mx-auto px-6 relative overflow-hidden">
          ...
          <div className="mb-8 inline-block p-1 rounded-full bg-gradient-to-tr from-cyan-400 to-blue-600 shadow-lg shadow-cyan-500/20">
            <img 
              src="/mr-abdallah.jpg" 
